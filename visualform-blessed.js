...
// Import Blessed.js module and fs.js module
...
// var label1Content = iconv.decode("姓 名:", 'gbk');
var label1 = blessed.text({
  parent: screen,
  top: 3,
  left: 5,
  content: "名/First Name:"
});
...
var label3 = blessed.text({
  parent: screen,
  content: '哪些是你最喜欢的编辑器/What are your favorite editors?',
  top: 14,
  left: 5
});
...
var label4 = blessed.text({
  parent: screen,
  content: '你喜欢Blessed吗/Do you like Blessed?',
  top: 19,
  left: 5
});
